...
export const metadata: Metadata = {
  ...
  description:
    '9 年以上全栈交付经验，专注企业级 SaaS、实时数据与 AI Agent 系统；React、Next.js、Node.js、Python 与 RAG 工程实践。',
};
...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body
        suppressHydrationWarning
        className="text-obsidian bg-paper selection:bg-acid/40 flex min-h-full cursor-none flex-col overflow-x-hidden font-sans"
      >
        <CustomCursor />
        <DynamicBackground />
        {children}
