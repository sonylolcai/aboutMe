...
export default function Home() {
  ...
  return (
    <main className="text-obsidian min-h-[100dvh] w-full bg-transparent">
      ...
      {!showIntro && (
        <div className="flex w-full flex-col">
          ...
          {/* Footer */}
          <footer className="border-obsidian mt-16 w-full border-t-2 py-10 text-center">
            <p className="font-display text-sm font-bold tracking-[-0.01em]">
              蔡璐阳（Sonny）｜企业级系统 · 实时数据 · AI Agent
            </p>
            <p className="text-muted mt-3 font-mono text-xs tracking-[0.08em]">
              Built with Next.js · React · TypeScript · © {new Date().getFullYear()}
            </p>
          </footer>
        </div>
      )}
